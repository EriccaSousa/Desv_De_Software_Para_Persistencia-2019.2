package teste.persistencia.teste_09_cassandra;

import java.time.LocalDateTime;
import java.util.List;

import teste.persistencia.teste_09_cassandra.dao.UserDAO;
import teste.persistencia.teste_09_cassandra.dao.cassandra.UserCassadraDAO;
...
public class Principal {
	...
	public static void main(String[] args) {
		...
		System.out.println("Bye, Cassandra DAO");
	}
